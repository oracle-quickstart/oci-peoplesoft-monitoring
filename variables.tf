...
variable "db_compartment" {
  type        = string
  description = "The compartment OCID where PSFT DB resides"
}
...
variable "db_cred_compartment" {
  type        = string
  description = "The compartment OCID where PSFT DB password secret resides"
}
...
variable "db_host" {
  type        = string
  description = "PSFT DB Host"
}

variable "db_port" {
  type        = number
  description = "PSFT DB Port"
}

variable "db_service" {
  type        = string
  description = "PSFT DB Service Name"
}


variable "db_credentials" {
  type        = string
  description = "OCID of secret in vault to use for connecting to PSFT DB"
}

variable "db_username" {
  type        = string
  description = "Username for connecting to PSFT DB"
}
...
variable "la_entity_name" {
  type        = string
  default     = "TestPSFT"
  description = "The PSFT Entity Name."
}
